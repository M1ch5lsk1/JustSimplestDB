...
Filename placeholder is filename, that'll be used to read ".txt" file or create "database_filename.py" file, program automatically adds needed extention to this files, that's the reason why you don't put filename with any extention.<br>
