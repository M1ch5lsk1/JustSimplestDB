...
Filename placeholder is filename(MUST TO BE A STRING AND PROVIDED FILENAME MUST BE WITHOUT EXTENTION), that'll be used to read ".txt" file or create "database_filename.py" file,<br>
